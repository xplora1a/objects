...
if part==1:
  ...
  d.add(intersection().add(bumpMapCylinder(innerR, hn+2, wall, 0).setModifier("")).add(translate([0,0,baseH]).add(cylinder(r=innerR+2*wall,h=h*1.1).setModifier(""))))
  #u.add()
  print "$fa=2; $fs=0.5;\n"
  print d.render()
elif part==2:
