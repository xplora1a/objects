 ...
 *     a rigid spoke design. Some of the features were inspired or suggested by commenters. I'll try 
 *     to add credits in the code for those features. 
 * 
...
timingHoles    = 18;         // The number of timing holes to carve into the rim
timingHolePad  = [1,1.1,2]; // The [inside,middle,outside] padding for the timing holes
...
treadStyle        = "none";        // none, cross, o-rings, squares, spheres, cylindersX, 
                                // 	  cylindersY, cylindersZ, spikes, slots, x, zigX, v
knobSize          = [5,14,1];   // The size of each knob [across wheel, along the perimeter, prodruding]
...
concavity         = [2,4];      // Concavity distance of spoke area for [inside, outside] of wheel
...
module hub( height, diameter, boreDiameter, nuts, nutSize, setScrewDiameter, setScrewNutOffset=0,
